...
def getParams():
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        if (len(cell_dict) > 0):
            global from_params
            from_params = phase_name[0], cell_dict
            help, helpp = from_params
            print(help)
            print(helpp)
...
Phase_1 = [K1_SB_0, K1_SB_1, K1_SB_2, K1_SB_3, K2_NB_R4_0, K2_NB_R4_1, K2_NB_R4_2, K2_NB_R4_3, K2_SB_0, K2_SB_1, K2_SB_2, K2_SB_3, K2_SB_4, K3_NB_0, K3_NB_1, K3_NB_2]
...
network = [K1_SB_0, K1_SB_1, K1_SB_2, K1_SB_3, K1_SB_4, BGon_0, BGon_1, TDrive_lower, TDrive_upper, TDrive_extension, K2_SB_0, K2_SB_1, K2_SB_2, K2_SB_3, K2_SB_4, K2_NB_R4_0, K2_NB_R4_1, K2_NB_R4_2, K2_NB_R4_3, K2_NB_R5R6_0, K2_NB_R5R6_1, K2_NB_R5R6_2, FdRosa_0, FdRosa_1, URd_upper_out, URd_lower_out, K3_NB_0, K3_NB_1, K3_NB_2]
...
if __name__ == "__main__":
    ...
    def read_input():  # test values only, should be integrated with TraCI
        current_phase, traci_cell_dict = from_params
